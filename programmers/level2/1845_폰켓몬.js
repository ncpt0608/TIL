...
function solution(nums) {
    ...
    for (let ix = 0, ixLen = nums.length; ix < ixLen; ix++) {
        objNums[nums[ix]] = nums[ix];
    } 
    count = Object.keys(objNums).length;
    halfCount = nums.length / 2 | 0
    
    return halfCount > count ? count : halfCount
}
